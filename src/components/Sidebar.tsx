...
const Sidebar: React.FC = () => {
  ...
  return (
    <div className="w-28 bg-[#272932] text-white min-h-screen p-4 flex flex-col items-center fixed z-20">
      <h2 className="mt-5 font-serif mb-6 flex items-center gap-2">
         GameSphere
      </h2>
      <ul className="flex flex-col items-center gap-9 w-full mt-10">
        ...
        <li>
          <Link
            ...
            passHref
            className={`block ${
              isActive("/tournaments") ? "text-[#6a3aba]" : "text-[#8F8F8F]"
            }`}
          >
        ...
        <li>
          <Link
            ...
            passHref
            className={`block ${
              isActive("/coins") ? "text-[#6a3aba]" : "text-[#8F8F8F]"
            }`}
          >
        ...
        <li>
          <Link
            ...
            passHref
            className={`block ${
              isActive("/about") ? "text-[#6a3aba]" : "text-[#8F8F8F]"
            }`}
          >
